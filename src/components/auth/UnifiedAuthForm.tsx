...
export function UnifiedAuthForm({ 
    ...
    try {
      ...
      if (mode === "signup") {
        ...
        if (result.success) {
          ...
          setMessage("✅ Account created successfully! Welcome to PromptBrain!");
          setTimeout(() => {
            onSuccess?.();
          }, 1500);
        } else {
  ...
  const toggleMode = () => {
    ...
    // Call navigation callbacks if provided
    if (newMode === "signup" && onNavigateToSignup) {
      onNavigateToSignup();
    } else if (newMode === "login" && onNavigateToLogin) {
      onNavigateToLogin();
    }
  };
        ...
        >
          ...
          <div className="text-center" style={{ marginBottom: "24px" }}>
            ...
            <div className="flex items-center justify-center mb-1">
              <div className="w-8 h-8 bg-gradient-to-r from-[#6E00FF] to-[#3B82F6] rounded-lg flex items-center justify-center mr-2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <AnimatePresence mode="wait">
              {mode === "signup" && !message && (
                ...
                >
                  Join thousands of users building smarter prompts.
                </motion.p>
              )}
            </AnimatePresence>
          </form>
