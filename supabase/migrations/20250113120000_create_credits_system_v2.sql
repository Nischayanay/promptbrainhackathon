...
CREATE INDEX IF NOT EXISTS idx_credits_log_created_at ON credits_log(created_at);
...
DROP POLICY IF EXISTS "Users can view own credit logs" ON credits_log;
DROP POLICY IF EXISTS "System can insert credit logs" ON credits_log;
